...
function show_supergroup_settingsmod(msg, target)
  ...
  local text = "\n#تنظیمات سوپر گروه:\n\nߔңقفل لینک : "..settings.lock_link.."\nߔңقفل اکانت: "..settings.lock_contacts.."\nߔңقفل فلود: "..settings.flood.."\n⛔️#مقدار حساسیت به اسپم: "..NUM_MSG_MAX.."\nߔңقفل اسپم: "..settings.lock_spam.."\nߔңقفل عربی/فارسی: "..settings.lock_arabic.."\nߔңقفل دعوت کردن: "..settings.lock_member.."\nߔңقفل ار تی ال: "..settings.lock_rtl.."\nߔңقفل نمایش ورود /خروج: "..settings.lock_tgservice.."\nߔңقفل استیکر: "..settings.lock_sticker.."\nߔңقفل تگ: "..settings.tag.."\nߔңقفل اموجی: "..settings.emoji.."\nߔңقفل انگلیسی: "..settings.english.."\nߔңقفل فروارد: "..settings.fwd.."\nߔңقفل ریپلای: "..settings.reply.."\nߔңقفل جوین با لینک: "..settings.join.."\nߔңقفل یوزرنیم: "..settings.username.."\nߔңقفل مدیا: "..settings.media.."\nߔңقفل فحش: "..settings.fosh.."\nߔңقفل برگشتن به گروه: "..settings.leave.."\nߔңقفل ربات api: "..bots_protection.."\nߔңقفل خدمات ارتباطی: "..settings.operator.."\nߔңقفل تمام لاک ها: "..settings.all.."\nߑţعمومی بودن گروه: "..settings.public.."\n❌#تنظیمات سخت گیرانه: "..settings.strict.."\nߌ#سویچ نوع : اتحاد : "..settings.etehad.."\n☣#سویچ نوع : نرمال : "..settings.lock_rtl.."\nߑʣسویچ نوع : خانوادگی : "..settings.lock_sticker.."\n\n✡#نوع گروه : "..gp_type.."\nߑŚɘǙƘǙĠربات:\n@KINGBOTTEAM\n__________\nߔјӘǘҙƘϙǠهای ربات :\n@mehdiisudo\n@mohammad20162015`"
  return text
end
